...
Next 5 days of your life
=========================================================

* Intro (45')
* Programing in R (Nacho) + Data viz (Paco)
* GLM & Mix models (Paco)
* Multivariant (Nacho) + Null Models (Nacho)
* RMarkdown, git y GitHub (Paco) + dplyr (Victor)
* GIS (Paco)
...
- Can't fix bad data
- Can't fix bad experimental dessign.
...
- [CRAN task views](https://cran.r-project.org/web/views/) (e.g. Bayesiano)
...
- [Quick-R](http://www.statmethods.net/): (PCA's, glm's, etc...)
- online courses:
